...
const (
	...
	InteractiveService_MustBatchGet_FullMethodName  = "/intr.v1.InteractiveService/MustBatchGet"
	InteractiveService_GetByIDs_FullMethodName      = "/intr.v1.InteractiveService/GetByIDs"
	InteractiveService_GetTopLike_FullMethodName    = "/intr.v1.InteractiveService/GetTopLike"
)
...
type InteractiveServiceClient interface {
	...
	GetTopLike(ctx context.Context, in *GetTopLikeRequest, opts ...grpc.CallOption) (*GetTopLikeResponse, error)
}
...
func (c *interactiveServiceClient) MustBatchGet(ctx context.Context, in *MustBatchGetRequest, opts ...grpc.CallOption) (*MustBatchGetResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(MustBatchGetResponse)
	err := c.cc.Invoke(ctx, InteractiveService_MustBatchGet_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *interactiveServiceClient) GetTopLike(ctx context.Context, in *GetTopLikeRequest, opts ...grpc.CallOption) (*GetTopLikeResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetTopLikeResponse)
	err := c.cc.Invoke(ctx, InteractiveService_GetTopLike_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type InteractiveServiceServer interface {
	...
	GetTopLike(context.Context, *GetTopLikeRequest) (*GetTopLikeResponse, error)
...
func (UnimplementedInteractiveServiceServer) MustBatchGet(context.Context, *MustBatchGetRequest) (*MustBatchGetResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method MustBatchGet not implemented")
}
...
func (UnimplementedInteractiveServiceServer) GetTopLike(context.Context, *GetTopLikeRequest) (*GetTopLikeResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetTopLike not implemented")
}
...
func _InteractiveService_MustBatchGet_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(MustBatchGetRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(InteractiveServiceServer).MustBatchGet(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: InteractiveService_MustBatchGet_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(InteractiveServiceServer).MustBatchGet(ctx, req.(*MustBatchGetRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _InteractiveService_GetTopLike_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetTopLikeRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(InteractiveServiceServer).GetTopLike(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: InteractiveService_GetTopLike_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(InteractiveServiceServer).GetTopLike(ctx, req.(*GetTopLikeRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var InteractiveService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "MustBatchGet",
			Handler:    _InteractiveService_MustBatchGet_Handler,
		},
		{
			MethodName: "GetByIDs",
		...
		{
			MethodName: "GetTopLike",
			Handler:    _InteractiveService_GetTopLike_Handler,
		},
	},
