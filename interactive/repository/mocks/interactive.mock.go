...
//
//	mockgen -source=./interactive.go -package=intrrepomocks -destination=./mocks/interactive.mock.go
//

// Package intrrepomocks is a generated GoMock package.
package intrrepomocks
