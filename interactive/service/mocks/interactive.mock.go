...
//
//	mockgen -source=./interactive.go -package=intrsvcmocks -destination=./mocks/interactive.mock.go
//

// Package intrsvcmocks is a generated GoMock package.
package intrsvcmocks
