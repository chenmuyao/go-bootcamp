...
//
//	mockgen -source=./code.go -package=svcmocks -destination=./mocks/code.mock.go
//
...
func (m *MockCodeService) Send(ctx context.Context, biz, phone string, tpl *template.Template) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Send", ctx, biz, phone, tpl)
	ret0, _ := ret[0].(error)
	return ret0
}

// Send indicates an expected call of Send.
func (mr *MockCodeServiceMockRecorder) Send(ctx, biz, phone, tpl any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Send", reflect.TypeOf((*MockCodeService)(nil).Send), ctx, biz, phone, tpl)
}
